...
class DataSet:
    ...
    def load_data(self, logger):
        ...
        triplets_train, triplets_aux, graph_train, self.num_relation, self.num_entity = self.doc_to_tensor_graph(
            train_path, aux_path)
        ...
        try:
            ...
            self.i2r = None
        try:
            self.i2e = self.build_entity_dict2(entity_idx_path, entity_name_path)
        except:
            self.i2e = None
    ...
    def build_entity_dict2(self, index_path, name_path):
        m2i = {}
